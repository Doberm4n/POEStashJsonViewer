...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(497, 404)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Dialog.sizePolicy().hasHeightForWidth())
        Dialog.setSizePolicy(sizePolicy)
        Dialog.setMinimumSize(QtCore.QSize(497, 404))
        Dialog.setMaximumSize(QtCore.QSize(497, 404))
        ...
        self.operandsComboBox = QtGui.QComboBox(self.filterGroupBox)
        self.operandsComboBox.setGeometry(QtCore.QRect(210, 20, 69, 22))
        self.operandsComboBox.setObjectName(_fromUtf8("operandsComboBox"))
        ...
        self.columnsHeadersComboBox.setMaxVisibleItems(20)
        ...
        self.applyFilterPushButton.setGeometry(QtCore.QRect(245, 370, 75, 23))
        self.applyFilterPushButton.setObjectName(_fromUtf8("applyFilterPushButton"))
        self.closePushButton = QtGui.QPushButton(Dialog)
        self.closePushButton.setGeometry(QtCore.QRect(415, 370, 75, 23))
        ...
        self.savedFiltersComboBox.setGeometry(QtCore.QRect(10, 20, 381, 22))
        ...
        self.saveFilterPushButton.setGeometry(QtCore.QRect(330, 370, 75, 23))
        self.saveFilterPushButton.setObjectName(_fromUtf8("saveFilterPushButton"))
        self.clearFilterPushButton = QtGui.QPushButton(Dialog)
        self.clearFilterPushButton.setGeometry(QtCore.QRect(5, 370, 75, 23))
        self.clearFilterPushButton.setObjectName(_fromUtf8("clearFilterPushButton"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.clearFilterPushButton.setText(_translate("Dialog", "Clear", None))
