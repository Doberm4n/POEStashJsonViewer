...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuGuide.addAction(self.actionOpenJson)
        self.menuGuide.addAction(self.actionOpenSingleJson)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpenJson.setText(_translate("MainWindow", "Open", None))
