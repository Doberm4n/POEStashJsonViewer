...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.filtersComboBox = QtGui.QComboBox(self.centralwidget)
        self.filtersComboBox.setObjectName(_fromUtf8("filtersComboBox"))
        self.verticalLayout_2.addWidget(self.filtersComboBox)
