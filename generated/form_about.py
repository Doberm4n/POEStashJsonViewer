...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.labelAbout.setGeometry(QtCore.QRect(60, 10, 206, 31))
        font = QtGui.QFont()
        ...
        self.versionLabel.setGeometry(QtCore.QRect(60, 65, 301, 16))
        self.versionLabel.setObjectName(_fromUtf8("versionLabel"))
        self.linkLabel = QtGui.QLabel(Dialog)
        self.linkLabel.setGeometry(QtCore.QRect(60, 95, 301, 16))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.labelAbout.setText(_translate("Dialog", "<html><head/><body><p>Stash Json Viewer for PoE <span style=\" font-size:8pt;\">by D0berm4n</span></p></body></html>", None))
